...
Public Function CaptureWindow(ByVal hWndSrc As Long, _
    ...
    ByVal HeightSrc As Long) As StdPicture
...
End With
End Function
Public Function CaptureForm(ahwnd As Long, x As Integer, y As Integer) As Picture
    Set CaptureForm = CaptureWindow(ahwnd, False, 0, 0, x, y)
End Function
